...
class EytzingerLayoutSearchNoPrefetch : public Search<KeyType> {
 private:
 ...
 public:
  ...
  void createLayout( std::vector<Row<KeyType>>& A, std::vector<Row<KeyType>>& B, uint64_t i, uint64_t n){
  ...
  std::string name() const { return "EytzingerLayoutSearchNoPrefetch"; }
};
