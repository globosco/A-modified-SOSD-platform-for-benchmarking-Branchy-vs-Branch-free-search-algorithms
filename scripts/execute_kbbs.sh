...
function do_benchmark() {
    ...
    if [ -f $RESULTS ]; then
        ...
        $BENCHMARK -r $2 ./data/$1 ./data/$1_equality_lookups_2M --pareto --search kbbs #| tee ./results/$1_results.txt
    fi
}
...
function do_benchmark_csv() {
    ...
    $BENCHMARK -r $2 ./data/$1 ./data/$1_equality_lookups_2M --pareto --csv --search kbbs
}
